      ...
      <div className="Body">
        ...
        <div className="welcome-msg">
          ...
          <div className="welcome-msg-txt slde-bottom">
            ...
            <Link to="/about"><button className="message-btn">More about us</button></Link>
          </div>
        ...
        <div className="accomodations">
          ...
          <div className="extra">
            <div className="extra-left acc">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nesciunt, molestias! Pariatur </p>
            </div>
            <div className="extra-right acc">
                <img src="./pool.jpg" alt="" />
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nesciunt, molestias! Pariatur repudiandae quod hic facilis!</p>
            </div>
          </div>
        </div>
